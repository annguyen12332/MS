...
public class TeacherScheduleController {
    ...
    /**
     * Xem lịch dạy theo lịch (calendar view)
     */
    @GetMapping
    public String viewSchedule(
        ...
        var schedules = scheduleService.findTeacherScheduleByDateRange(currentTeacher, startDate, endDate);
        ...
        return "teacher/schedule/calendar";
    }
}
